...
exports.fetchData = async function () {
    // const fs = require("fs");
    // return await JSON.parse(fs.readFileSync('stores/albertF.json'));
    ...
    for (let levels of categories.data.leftHandNavigationBar.levelInfo) {
        ...
        do {
            ...
            console.log(levels.name + " " + items.length + "/" + remains);
    ...
    // const fs = require("fs");
    // fs.writeFileSync('stores/albertF.json', JSON.stringify(albertItems,null,2));
    return albertItems;
};
